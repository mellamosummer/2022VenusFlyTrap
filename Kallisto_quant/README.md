There are 48 folders here corresponding to each sample & replicate. Each folder contains 3 files: 1) abundance.h5, 2) abundance.tsv, and 3) abundance.tsv file. These are used for the Sleuth DEG analysis. 
